...
$this->title = 'ภาพรวมการให้บริการคลินิคgเบาหวาน DM Deatil';
            ...
            <table class="table table-hover">
               ...
               <td><?php echo $lab_rs['name']; ?></td>
                <td><center><?php echo $lab_rs['man']; ?></center></td><td><center><?php echo $lab_rs['n']; ?></center></td>
                  ...
                  <?php } ?>
                <tr>
                    <th colspan="3"><center>ผู้ป่วยเบาหวาน ที่ได้รับการคัดกรองการทำงานของไต (eGFR)</center></th>
                </tr>
               ...
               <td><?php echo $egfr_rs['name']; ?></td>
                <td><center>-</center></td><td><center><?php echo $egfr_rs['n']; ?></center></td>
                  ...
                  <?php } ?>
                <tr>
                    <th colspan="3"><center>งานติดตามดูแลผู้ป่วยเบาหวาน ตามปิงปอง 7 สี</center></th>
                </tr>
